...
RSpec.describe Legion::Extensions::Agentic::Affect::SomaticMarker::Runners::SomaticMarker do
  let(:client) { Legion::Extensions::Agentic::Affect::SomaticMarker::Client.new }
